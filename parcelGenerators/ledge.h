...
*       Ledge parcels can only meaningfully be of L, I, TL, or TI shape, with some extra walkway-clashing limitations, because the parcel algorithm
...
*       If the parcel is of TL shape, the ledge is (arbitrarily chosen to be) forcing one-way traversal from the noncritical "exit" to the critical path.
